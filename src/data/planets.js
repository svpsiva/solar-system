...
export const PLANETS = [
  {
    ...
    moons: [],
    surfaceType: 'icy',
    surface: { groundColor: 0x7a7570, skyColor: 0x080808, roughness: 1.0, sunScale: 2.5 },
    narration: {
      name: 'Mercury!',
  ...
  },
  {
    ...
    moons: [],
    surfaceType: 'volcanic',
    surface: { groundColor: 0x8a4a20, skyColor: 0xc8601a, roughness: 0.9, sunScale: 1.4 },
    narration: {
      name: 'Venus!',
  ...
  },
  {
    ...
    hasRings: false,
    moons: [
      { name: 'Phobos', radius: 0.25, orbitRadius: 2.4, speed: 1.8, color: 0x9a8a7a, textureType: 'rocky' },
  ...
  },
  {
    ...
    hasRings: false,
    moons: [
      { name: 'Metis',    radius: 0.14, orbitRadius: 3.8, speed: 2.20, color: 0x9a8a7a, textureType: 'rocky' },
      { name: 'Amalthea', radius: 0.18, orbitRadius: 4.4, speed: 1.90, color: 0xc87850, textureType: 'rocky' },
      { name: 'Thebe',    radius: 0.15, orbitRadius: 4.8, speed: 1.75, color: 0xa08070, textureType: 'rocky' },
      { name: 'Io',       radius: 0.40, orbitRadius: 5.8, speed: 1.60, color: 0xe8d27a, textureType: 'lava'  },
      { name: 'Europa',   radius: 0.38, orbitRadius: 7.0, speed: 1.30, color: 0xd8cbb0, textureType: 'icy'   },
      { name: 'Ganymede', radius: 0.50, orbitRadius: 8.4, speed: 1.00, color: 0xa89a86, textureType: 'rocky' },
      { name: 'Callisto', radius: 0.46, orbitRadius: 9.8, speed: 0.80, color: 0x8a7a6a, textureType: 'rocky' },
    ],
    surfaceType: 'gas',
  ...
  },
  {
    ...
    moons: [
      { name: 'Mimas',      radius: 0.20, orbitRadius: 5.2,  speed: 1.80, color: 0xd0ccc8, textureType: 'rocky' },
      { name: 'Enceladus',  radius: 0.22, orbitRadius: 6.0,  speed: 1.55, color: 0xeeeeff, textureType: 'icy'   },
      { name: 'Tethys',     radius: 0.26, orbitRadius: 6.9,  speed: 1.35, color: 0xd8d4cc, textureType: 'rocky' },
      { name: 'Dione',      radius: 0.27, orbitRadius: 7.8,  speed: 1.15, color: 0xccc8c0, textureType: 'rocky' },
      { name: 'Rhea',       radius: 0.32, orbitRadius: 8.8,  speed: 0.95, color: 0xc8c0b0, textureType: 'rocky' },
      { name: 'Titan',      radius: 0.55, orbitRadius: 10.2, speed: 0.75, color: 0xd8a85a, textureType: 'titan' },
      { name: 'Iapetus',    radius: 0.28, orbitRadius: 12.0, speed: 0.50, color: 0xa09080, textureType: 'rocky' },
    ],
    surfaceType: 'gas',
  ...
  },
  {
    ...
    ringColor: 0x9fdfe0,
    moons: [
      { name: 'Miranda',  radius: 0.20, orbitRadius: 4.0, speed: 1.60, color: 0xb0b8bc, textureType: 'icy'   },
      { name: 'Ariel',    radius: 0.28, orbitRadius: 5.0, speed: 1.30, color: 0xc0c8cc, textureType: 'icy'   },
      { name: 'Umbriel',  radius: 0.27, orbitRadius: 6.1, speed: 1.05, color: 0x808890, textureType: 'rocky' },
      { name: 'Titania',  radius: 0.35, orbitRadius: 7.4, speed: 0.82, color: 0xbfcfd0, textureType: 'icy'   },
      { name: 'Oberon',   radius: 0.33, orbitRadius: 8.8, speed: 0.64, color: 0xa8b0b8, textureType: 'rocky' },
    ],
    surfaceType: 'gas',
  ...
  },
  {
    ...
    hasRings: false,
    moons: [
      { name: 'Triton', radius: 0.42, orbitRadius: 5.2, speed: 0.90, color: 0xbcd0e0, textureType: 'icy'   },
      { name: 'Nereid', radius: 0.18, orbitRadius: 7.8, speed: 0.45, color: 0x9090a8, textureType: 'rocky' },
    ],
    surfaceType: 'gas',
